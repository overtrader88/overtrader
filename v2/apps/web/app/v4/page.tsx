...
export const metadata: Metadata = {
  title: "Overtrader — Veja a IA provar o sinal, ao vivo (v4)",
  description:
    "Versão em avaliação. A IA de trading que valida cada sinal camada por camada, com amostra, intervalo de confiança e período — e diz quando NÃO operar.",
    ...
    <div className={v.page}>
      ...
      <nav className={v.nav}>
        <div className={`${v.wrap} ${v.navRow}`}>
          <a className={v.brand} href="/v4" aria-label="Overtrader">
            <Logo />
          ...
          <div className={v.switcher} role="group" aria-label="Versões da landing">
            ...
            <a href="/nova">v2</a>
            <a href="/v3">v3</a>
            <a href="/v4" className={v.switchActive} aria-current="page">v4</a>
          </div>
