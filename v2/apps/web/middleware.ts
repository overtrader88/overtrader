...
// "/nova", "/v3", "/v4" = landings alternativas em avaliação (mesma natureza pública da "/").
const PUBLIC = new Set(["/", "/nova", "/v3", "/v4", "/login", "/recuperar", "/redefinir-senha", "/termos", "/privacidade"]);
