...
export type EngineFilter = "padrao" | "padrao_b" | "classe" | "classe_b" | "llm" | "llm_ds" | "llm_surv" | "llm_ds_surv" | "llm_vsf" | "llm_ds_vsf" | "condicional" | "contrario" | "consenso";
/** Todos os motores — usado na visão consolidada ("Todos"). */
const ALL_ENGINES = ["padrao", "padrao_b", "classe", "classe_b", "llm", "llm_ds", "llm_surv", "llm_ds_surv", "llm_vsf", "llm_ds_vsf", "condicional", "contrario", "consenso"];
