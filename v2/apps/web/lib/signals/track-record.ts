...
export type EngineFilter = "padrao" | "padrao_b" | "classe" | "classe_b" | "llm" | "condicional" | "contrario" | "consenso";
/** Todos os motores — usado na visão consolidada ("Todos"). */
const ALL_ENGINES = ["padrao", "padrao_b", "classe", "classe_b", "llm", "condicional", "contrario", "consenso"];
